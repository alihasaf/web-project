...
export default function DubataProductDetail() {
  ...
  const product = {
    id: slug || "dubata-id",
    name: slug?.replace(/-/g, " ") || "Dubata",
    img: "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
    price: 899,
    description: "Beautiful dubata. You can add fabric, color, size, and other details here.",
    details: [
