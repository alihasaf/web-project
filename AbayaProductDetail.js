...
export default function AbayaProductDetail() {
  ...
  const product = {
    id: slug || "abaya-id",
    name: slug?.replace(/-/g, " ") || "Abaya",
    img: "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80",
    price: 5999,
    description: "Beautiful abaya. You can add fabric, color, size, and other details here.",
    details: [
      { label: "Fabric", value: "Nida" },
